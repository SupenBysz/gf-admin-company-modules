...
type (
	...
	IFdInvoiceDetailBase interface {
...
type IModuleBase interface {
	...
	Dao() *co_dao.XDao
	GetICompany() ICompanyBase
	GetITeam() ITeamBase
	GetIEmployee() IEmployeeBase
	GetIFdAccount() IFdAccountBase
	GetIFdAccountBills() IFdAccountBillsBase
	GetIFdBankCard() IFdBankCardBase
	GetIFdInvoice() IFdInvoiceBase
	GetIFdInvoiceDetail() IFdInvoiceDetailBase
	GetIFdRecharge() IFdRechargeBase
}
