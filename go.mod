...
require (
	github.com/SupenBysz/gf-admin-community v0.5.5
	github.com/gogf/gf/v2 v2.5.0
	github.com/kysion/base-library v0.0.21
...
require (
	...
	github.com/gogf/gf/contrib/drivers/pgsql/v2 v2.5.0 // indirect
	github.com/gogf/gf/contrib/nosql/redis/v2 v2.5.0 // indirect
