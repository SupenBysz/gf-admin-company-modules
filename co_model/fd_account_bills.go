...
type AccountBillsRegister struct {
	...
	BuyerUserId   int64                                        `json:"-"             orm:"-"              description:"买家用户ID"`
	...
	TradeState    int                                          `json:"tradeState"    orm:"trade_state"    description:"交易状态：0无、1待支付、2支付中、4已支付、8取消支付、16交易完成、32退款中、64已退款、128支付超时、256已关闭、512已冻结、1024、已解冻、2048解冻失败"`
