...
func (dao *FdInvoiceDao) GetExtWhereKeys() []string {
	return dao.exWhereArr
}

func (dao *FdInvoiceDao) IsIgnoreCache() bool {
	return dao.ignoreCache
}

func (dao *FdInvoiceDao) IgnoreCache() dao_interface.IDao {
	dao.ignoreCache = true
	return dao
}
func (dao *FdInvoiceDao) IgnoreExtModel(whereKey ...string) dao_interface.IDao {
