...
func (dao *FdInvoiceDetailDao) GetExtWhereKeys() []string {
	return dao.exWhereArr
}

func (dao *FdInvoiceDetailDao) IsIgnoreCache() bool {
	return dao.ignoreCache
}

func (dao *FdInvoiceDetailDao) IgnoreCache() dao_interface.IDao {
	dao.ignoreCache = true
	return dao
}
func (dao *FdInvoiceDetailDao) IgnoreExtModel(whereKey ...string) dao_interface.IDao {
