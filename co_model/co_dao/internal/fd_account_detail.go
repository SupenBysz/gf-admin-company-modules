...
func (dao *FdAccountDetailDao) GetExtWhereKeys() []string {
	return dao.exWhereArr
}

func (dao *FdAccountDetailDao) IsIgnoreCache() bool {
	return dao.ignoreCache
}

func (dao *FdAccountDetailDao) IgnoreCache() dao_interface.IDao {
	dao.ignoreCache = true
	return dao
}
func (dao *FdAccountDetailDao) IgnoreExtModel(whereKey ...string) dao_interface.IDao {
