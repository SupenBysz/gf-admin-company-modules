...
type FdAccount struct {
	...
	AccountType        int         `json:"accountType"        orm:"account_type"         description:"账户类型：0 - 系统账户、1 - 银行卡；2 - 支付宝；3 - 微信；4 - 云闪付；5 - ApplePay；6 - PayPal；7 - AmazonPay；8 - 线下现金（若有对应业务）；9 - 区块链钱包；100 - 其他（可进一步在备注说明）"`
