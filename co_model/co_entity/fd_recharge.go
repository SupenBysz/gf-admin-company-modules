...
type FdRecharge struct {
	...
	RechargeMethod int         `json:"rechargeMethod" orm:"recharge_method"  description:"充值方式：1 - 银行卡；2 - 支付宝；3 - 微信；4 - 云闪付；5 - ApplePay；6 - PayPal；7 - AmazonPay；8 - 线下现金（若有对应业务）；9 - 区块链钱包；100 - 其他（可进一步在备注说明）"`
