...
type DeleteTeamReq struct {
	g.Meta `method:"post" summary:"删除团队或小组|信息" tags:"团队或小组"`
	Id     int64 `json:"id" v:"required#团队ID校验失败" dc:"团队或小组ID"`
}

type GetTeamMemberListReq struct {
	g.Meta `method:"post" summary:"获取团队成员|列表" tags:"团队或小组"`
	Id     int64 `json:"id" v:"required#团队ID校验失败" dc:"团队或小组ID"`
}

type QueryTeamByEmployeeListReq struct {
	g.Meta      `method:"post" summary:"根据员工查询团队|列表" tags:"团队或小组"`
